...
public:
	...
	void updatePositionExplicitConst(float dt, int n);
	...
	void updatePosition(double* Dis);
	void updatePosition();
	void updatePosition(double* nodeforce, double C, double dt, int itter);
	void addDisplacement(int index, double Value);
	// add internal force
	...
	double* returnInternalForce(float dt);
