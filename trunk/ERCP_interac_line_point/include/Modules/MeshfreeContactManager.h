...
public:
	...
	void contactResolutionWithTool(Meshfree_CPU* obj, CollisionManager* collision, float dt);
...
private:
	...
	void constructMappingMatrixSparseV2(Meshfree_CPU* obj, std::vector<int>& colTriIndex, std::vector<Vec3f>& colNormal, std::vector<int>& relatedNodeIdx, Matrix& HT, Matrix& HCHT, float dt);
